...
Top 10 Trending News {.storyboard}
=========================

Information {.sidebar}
-----------------------------------------------------------------------
This is a dashboard for Gdelt Project
...
# Render a DataTable in a nice format
datatable(sorted_data, options = list(pageLength = 10, autoWidth = TRUE),
          filter = 'top',  # Allows filtering data for each column
          rownames = FALSE,
          class = 'cell-border stripe',  # Styling options
          editable = TRUE)  # Enables editing the data directly in the table, useful for demos or interactive sessions
